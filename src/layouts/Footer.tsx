      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="md:text-start px-5 py-4 flex flex-col items-center md:items-start">
          ...
          <div className="w-14/15 h-[3rem] border-[var(--color-text-primary)] border-2 rounded-md overflow-hidden">
            ...
            />
            <button className="h-[3rem] w-[30%] uppercase text-[--color-footer-bg] font-medium bg-[var(--color-text-primary)] text-[0.9rem] cursor-pointer hover:bg-[var(--color-text-secondary)] transition-colors">
              subscribe
            </button>
          </div>
        </div>
